<?php
class BrunnSelectElementorProductInfo extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Info', 'brunn-core' );
	}

	public function get_icon() {
		return 'brunn-elementor-custom-icon brunn-elementor-product-info';
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'product_id',
			[
				'label'     => esc_html__( 'Selected Product', 'brunn-core' ),
				'type'      => \Elementor\Controls_Manager::TEXT,
				'description' => esc_html__( 'If you left this field empty then product ID will be of the current page', 'brunn-core' )
			]
		);
		...
		$this->add_control(
			'product_info_type',
			[
				'label'     => esc_html__( 'Product Info Type', 'brunn-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'title' => esc_html__( 'Title', 'brunn-core'), 
					'featured_image' => esc_html__( 'Featured Image', 'brunn-core'), 
					'category' => esc_html__( 'Category', 'brunn-core'), 
					'excerpt' => esc_html__( 'Excerpt', 'brunn-core'), 
					'price' => esc_html__( 'Price', 'brunn-core'), 
					'rating' => esc_html__( 'Rating', 'brunn-core'), 
					'add_to_cart' => esc_html__( 'Add To Cart', 'brunn-core'), 
					'tag' => esc_html__( 'Tag', 'brunn-core'), 
					'author' => esc_html__( 'Author', 'brunn-core'), 
		...
		$this->add_control(
			'featured_image_size',
			[
				'label'     => esc_html__( 'Featured Image Proportions', 'brunn-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
		...
		$this->add_control(
			'add_to_cart_skin',
			[
				'label'     => esc_html__( 'Add To Cart Skin', 'brunn-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'' => esc_html__( 'Default', 'brunn-core'), 
		...
		$this->add_control(
			'product_info_color',
			[
				'label'     => esc_html__( 'Product Info Color', 'brunn-core' ),
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::SELECT,
				'description' => esc_html__( 'Set title tag for product title element', 'brunn-core' ),
				'options' => array(
		...
		$this->add_control(
			'category_tag',
			[
				'label'     => esc_html__( 'Category Tag', 'brunn-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'description' => esc_html__( 'Set category tag for product category element', 'brunn-core' ),
				'options' => array(
					'h1' => esc_html__( 'h1', 'brunn-core'), 
					'h2' => esc_html__( 'h2', 'brunn-core'), 
					'h3' => esc_html__( 'h3', 'brunn-core'), 
		...
		$this->add_control(
			'add_to_cart_size',
			[
				'label'     => esc_html__( 'Add To Cart Size', 'brunn-core' ),
				'type'      => \Elementor\Controls_Manager::SELECT,
				'options' => array(
					'' => esc_html__( 'Default', 'brunn-core'), 
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new BrunnSelectElementorProductInfo() );