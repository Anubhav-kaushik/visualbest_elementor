...
if ( ! class_exists( 'BrunnCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class BrunnCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'brunn-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'brunn_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	BrunnCoreDashboardRestAPI::get_instance();
}