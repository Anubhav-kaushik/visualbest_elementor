<?php
namespace BrunnCore\CPT\Shortcodes\GoogleMap;
...
class GoogleMap implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Google Map', 'brunn-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							'type'       => 'textfield',
							'param_name' => 'address1',
							'heading'    => esc_html__( 'Address 1', 'brunn-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address2',
							'heading'    => esc_html__( 'Address 2', 'brunn-core' ),
							'dependency' => Array( 'element' => 'address1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address3',
							'heading'    => esc_html__( 'Address 3', 'brunn-core' ),
							'dependency' => Array( 'element' => 'address2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address4',
							'heading'    => esc_html__( 'Address 4', 'brunn-core' ),
							'dependency' => Array( 'element' => 'address3', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'address5',
							'heading'    => esc_html__( 'Address 5', 'brunn-core' ),
							'dependency' => Array( 'element' => 'address4', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'snazzy_map_style',
							'heading'     => esc_html__( 'Snazzy Map Style', 'brunn-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Snazzy Map Code', 'brunn-core' ),
							'description' => sprintf( esc_html__( 'Fill code from snazzy map site %s to add predefined style for your google map', 'brunn-core' ), '<a href="https://snazzymaps.com/" target="_blank">https://snazzymaps.com/</a>' ),
							'dependency'  => Array( 'element' => 'snazzy_map_style', 'value' => array( 'yes' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'custom_map_style',
							'heading'     => esc_html__( 'Custom Map Style', 'brunn-core' ),
							'value'       => array_flip( brunn_select_get_yes_no_select_array( false ) ),
						...
						array(
							...
							'heading'     => esc_html__( 'Color Overlay', 'brunn-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Saturation', 'brunn-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Lightness', 'brunn-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Zoom Map on Mouse Wheel', 'brunn-core' ),
							'value'       => array_flip( brunn_select_get_yes_no_select_array( false ) ),
						...
						array(
							...
							'heading'    => esc_html__( 'Map Height (px)', 'brunn-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = brunn_core_get_shortcode_module_template_part( 'templates/google-map-template', 'google-map', '', $params );
