<?php
class BrunnCoreElementorFrameSlider extends \Elementor\Widget_Base {

	public function get_name() {
		return 'qodef_frame_slider'; 
	}

	public function get_title() {
		return esc_html__( 'Frame Slider', 'brunn-core' );
	}

	public function get_icon() {
		return 'brunn-elementor-custom-icon brunn-elementor-frame-slider';
	}
	...
	public function render() {
		...
		echo brunn_core_get_shortcode_module_template_part( 'templates/frame-slider', 'frame-slider', '', $params );
	}
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new BrunnCoreElementorFrameSlider() );